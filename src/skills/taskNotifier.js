const TaskEvent = {
  ...
  class TaskEventNotifier {
    ...
    constructor() {
      ...
      this.socket.onmessage = async (msg) => {
        try {
          ...
          // Handle heartbeat configuration
          if (event.type === 'heartbeat' && event.interval) {
            this.startHeartbeat(event.interval);
            return;
          }
    ...
    startHeartbeat(interval) {
      ...
      }, interval - 200); // Client pongs slightly before server checks
    }
